...
def generate_html_summary(system_prompt, model_name, elapsed_time, num_images, model_f1, model_hallucination_rate, total_correct, total_ground_truth_players, total_false_alarms, model_df):
    prompt_html = (
    ...
    summary_rows = [
        ...
        ("Hallucination Rate", f"{model_hallucination_rate * 100:.2f} %"),
